...
declare const OTPInput: React.ForwardRefExoticComponent<OTPInputProps & React.RefAttributes<OTPRef>>;
export type { OTPInputProps, InputProps, AllowedInputTypes, OTPRef };
